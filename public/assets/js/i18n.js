...
const DICT = {
  fa: {
    ...
    'room.fullscreen': 'تمام‌صفحه',

    'call.title': 'تماس',
    'call.start': 'تماس تصویری',
    'call.leave': 'خروج از تماس',
    'call.hint': 'تا ۴ نفر — صدای فیلم موقع حرف زدن خودکار کم می‌شود.',
    'call.hintCount': '{n} نفر در تماس‌اند (حداکثر ۴).',
    'call.hintFull': 'تماس پر است (۴ از ۴).',
    'call.you': 'تو',
    'call.joined': 'به تماس پیوست',
    'call.collapse': 'جمع کردن نوار تماس',
    'call.muteMic': 'قطع میکروفون',
    'call.unmuteMic': 'وصل میکروفون',
    'call.stopCam': 'قطع دوربین',
    'call.startCam': 'روشن کردن دوربین',
    'call.toAudio': 'تبدیل به تماس صوتی (تماس قطع نمی‌شود)',
    'call.toVideo': 'تبدیل به تماس تصویری (تماس قطع نمی‌شود)',
    'call.nowAudio': 'تماس صوتی شد 🎙️',
    'call.nowVideo': 'تماس تصویری شد 🎥',
    'call.permission': 'اجازه دسترسی به میکروفون/دوربین داده نشد.',
    'call.unsupported': 'مرورگر تو از تماس تصویری پشتیبانی نمی‌کند.',
    'call.failed': 'شروع تماس ممکن نشد.',
    'call.cameraFailed': 'دوربین در دسترس نیست؛ تماس صوتی ادامه دارد.',
    'call.notInRoom': 'اول باید وارد اتاق شوی.',
    'call.full': 'تماس پر است (حداکثر {n} نفر).',
    'call.crowded': 'بیش از ۴ نفر در تماس — هر نفر حدود ۲٫۴ مگابیت آپلود لازم دارد و روی اینترنت موبایل کیفیت افت می‌کند.',
    'call.dropped': 'ارتباط قطع شد؛ تماس بسته شد.',
    'call.needRelay': 'اتصال مستقیم ممکن نشد — TURN لازم است.',
    'call.needRelayShort': 'TURN لازم است',
    'call.duckSettings': 'تنظیمات کم شدن صدا',
    'call.duckTitle': 'کم شدن هوشمند صدای فیلم',
    'call.duckEnable': 'فعال',
    'call.duckSense': 'حساسیت',
    'call.duckDepth': 'شدت کم شدن',
    'call.duckActive': 'کسی حرف می‌زند — صدای فیلم کم شد 🔉',
    'call.duckIdle': 'صدای فیلم عادی است',
  ...
  en: {
    ...
    'call.hint': 'Up to 4 people — the movie ducks automatically while someone talks.',
    'call.hintCount': '{n} in the call (max 4).',
    'call.hintFull': 'The call is full (4 of 4).',
    'call.you': 'You',
    'call.joined': 'joined the call',
    'call.collapse': 'Collapse the call strip',
    'call.muteMic': 'Mute microphone',
    'call.unmuteMic': 'Unmute microphone',
    'call.stopCam': 'Turn camera off',
    'call.startCam': 'Turn camera on',
    'call.toAudio': 'Switch to voice only (stays connected)',
    'call.toVideo': 'Switch to video (stays connected)',
    'call.nowAudio': 'Voice-only call 🎙️',
    'call.nowVideo': 'Video call 🎥',
    'call.permission': 'Microphone/camera permission was denied.',
    'call.unsupported': 'Your browser does not support video calls.',
    'call.failed': 'Could not start the call.',
    'call.cameraFailed': 'No camera available; continuing as a voice call.',
    'call.notInRoom': 'Join the room first.',
    'call.full': 'The call is full (max {n} people).',
    'call.crowded': 'More than 4 people in the call — each person needs ~2.4 Mbps upload, which mobile connections struggle with.',
    'call.dropped': 'Connection lost; the call was closed.',
    'call.needRelay': 'Direct connection failed — a TURN server is required.',
    'call.needRelayShort': 'TURN required',
    'call.duckSettings': 'Ducking settings',
    'call.duckTitle': 'Smart movie-audio ducking',
    'call.duckEnable': 'Enabled',
    'call.duckSense': 'Sensitivity',
    'call.duckDepth': 'Duck depth',
    'call.duckActive': 'Someone is talking — movie ducked 🔉',
    'call.duckIdle': 'Movie audio at normal level',
